...
export enum BasketballEvents {
    ...
    TeamLevel = 'basketball.team.level', // refers to team id
    PlayerLevel = 'basketball.player.level', // refers to team id
    ...
    PlayerScores3FG = 'basketball.player.scores.3fg', // refers to player id
